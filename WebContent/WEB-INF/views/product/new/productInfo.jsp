        ...
        $.get(
                ...
                function(result){
                    if("success"==result){
                        var pid = ${p.id};
                        var num= $(".productNumberSetting").val();
                        var addCartpage = "test?method=addCart";//"foreaddCart";
                        $.get(
                                addCartpage,
                                {"pid":pid,"num":num},
                                function(result){
...
<title>天猫官网-商品明细</title>
</head>
<body>
<%@ include file="/static/include/top.jsp" %>
<div class="categoryPictureInProductPageDiv">
	<img class="categoryPictureInProductPage" src="${contextStatic }/img/category/${p.category.id}.jpg">
</div>
...
<div class="imgAndInfo">
    ...
    <div class="imgInimgAndInfo">
        <img src="static/img/productSingle/19.jpg" class="bigImg">
        <div class="smallImageDiv">
           <%-- 
            <c:forEach items="${p.productSingleImages}" var="pi">
                <img src="static/img/productSingle_small/${pi.id}.jpg" bigImageURL="img/productSingle/${pi.id}.jpg" class="smallImage">
            </c:forEach>
            --%>
        </div>
    ...
    <div class="infoInimgAndInfo">
        ...
        <div class="buyDiv">
            ...
            <a class="addCartLink" href="${context }/cart?method=add&pid=${p.id}">
...
<div class="productReviewDiv" >
	<div class="productReviewTopPart">
		...
		<span class="productReviewTopReviewLinkNumber">${p.reviewCount}</span> </a>
	</div>
...
<div class="productDetailDiv" >
	...
	<div class="productDetailImagesPart">
		<c:forEach items="${p.productDetailImages}" var="pi">
			<img src="static/img/productDetail/${pi.id}.jpg">
		</c:forEach>
	</div>
</div>
--%>
